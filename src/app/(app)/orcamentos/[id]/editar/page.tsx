...
import { OrcamentoBuilder } from "../../novo/OrcamentoBuilder";
...
export default async function EditarOrcamentoPage({
  ...
  // da observação por item, ver actions.ts). Manda de volta pra tela de
  // detalhe com o motivo, em vez de deixar o formulário abrir à toa.
  if (orcamento.pdfGeradoEm) {
    redirect(
      `/orcamentos/${orcamentoId}?erro=` +
