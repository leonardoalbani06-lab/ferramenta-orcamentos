...
const styles = StyleSheet.create({
  ...
  headerLeft: { flex: 1, padding: 8, alignItems: "center", justifyContent: "center" },
  headerRight: {
    width: 130,
    padding: 8,
    alignItems: "center",
  ...
  empresa: { fontSize: 11, fontWeight: 700, marginBottom: 2, textAlign: "center" },
  representante: { fontSize: 9, marginBottom: 2 },
        ...
        <View style={styles.documentBox}>
          <View style={styles.headerRow}>
            <View style={styles.headerLeft}>
              <Text style={styles.empresa}>D&apos;Classe Ind e Com de Papeis</Text>
              <Text style={styles.representante}>{orcamento.representante.nome}</Text>
            </View>
          ...
          <View style={styles.row}>
            <Campo label="TABELA DE PREÇO" valor={orcamento.tabelaUsada} />
